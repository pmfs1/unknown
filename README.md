...
<!-- make uninstall && sudo apt-get update -y && sudo apt install make gcc g++ nvidia-cuda-toolkit -y && make install && make cuda-install CUDA_ARCH=sm_61 && cd .benchmark/cuda && make && ./bin/bench && cd .. && cd std && make && ./bin/bench && cd ../../../.. && make uninstall -->
